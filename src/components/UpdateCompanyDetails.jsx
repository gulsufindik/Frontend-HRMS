...
const updateCompanyDetailsUrlCloud = "http://34.123.15.45/company/update";
const findByCompanyNameUrl = `http://localhost:8080/company/findbycompanyname?companyName=${localStorage.getItem(
  "companyName"
)}`;
const findByCompanyNameUrlCloud = `http://34.123.15.45/company/findbycompanyname?companyName=${localStorage.getItem(
  "companyName"
)}`;
